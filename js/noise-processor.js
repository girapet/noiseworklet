...
// based on "How to Generate Noise with the Web Audio API" by Zack Dennon
//   https://noisehack.com/generate-noise-web-audio-api/
// from Paul Kellet's instrumentation grade filter in
...
registerProcessor('noise-processor', class extends AudioWorkletProcessor {
  constructor(options) {
    super();
    this.random = [];
    const channelCount = options.outputChannelCount || 1;

    for (let c = 0; c < channelCount; c++) {
      this.random[c] = createRandomPink();
    }
  }
